const { TextureAnimation } = require('../');
const { Texture } = require('@pixi/core');

describe('PIXI.TextureAnimation', function ()
{
    describe('instance', function ()
    {
        ...
        {
            this.sprite = new TextureAnimation(this.textures);
            expect(this.sprite._autoUpdate).to.be.true;
        });

        it('should be correct with autoUpdate=false', function ()
        {
            this.sprite = new TextureAnimation(this.textures, false);
    ...
    describe('.stop()', function ()
    {
        before(function ()
        {
            this.sprite = new TextureAnimation([Texture.EMPTY], false);
        });
