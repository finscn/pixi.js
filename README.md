...
```html
<script src="https://cdnjs.cloudflare.com/ajax/libs/pixi.js/4.2.1/pixi.min.js"></script>
```

_Note: `4.2.1` can be replaced by any [released](https://github.com/pixijs/pixi.js/releases) version._
