 ...
 *
 */
export default class MultiColorReplaceFilter extends core.Filter
{
    ...
    set originalColors(value)
    {
        ...
        for (let i = 0; i < this.colorCount; i++)
        {
            ...
            if (typeof color === 'number')
            {
                ...
                color = core.utils.hex2rgb(color);
            }
            else
            {
                this._originalColors[i] = core.utils.rgb2hex(color);
            }
    ...
    set targetColors(value)
    {
        ...
        for (let i = 0; i < this.colorCount; i++)
        {
            ...
            {
                this._targetColors[i] = core.utils.rgb2hex(color);
            }
